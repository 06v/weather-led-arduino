...
That's needed in order to acces the Openweather API, we will retrieve our weather data through it.<br/>You will be running the script locally so I won't be able to store your API key.
